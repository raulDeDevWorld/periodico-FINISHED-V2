                                ...
                                <div>
                                    {
                                        router.pathname === "/Admin" ?
                                            <span onClick={() => handlerClickEnlace({ carpeta: 'BannerPortada', item: '', i })}><img className={styles.boxImg} src={userDB[`BannerPortada`][i].url} /></span>
                                            : <span onClick={() => redirect(userDB[`BannerPortada`][i].enlace ? userDB[`BannerPortada`][i].enlace : '#')}><img className={styles.boxImg} src={userDB[`BannerPortada`][i].url} /></span>
                                    }
                                </div>
                            </div>
                        )
                                            ...
                                            <div>
                                                {
                                                    router.pathname === "/Admin" ?
                                                        <span onClick={() => handlerClickEnlace({ carpeta: 'BannerPortada', item: '', i })}><img className={styles.boxImg} src={userDB[`BannerPortada`][i].url} /></span>
                                                        : <span onClick={() => redirect(userDB[`BannerPortada`][i].enlace ? userDB[`BannerPortada`][i].enlace : '#')}><img className={styles.boxImg} src={userDB[`BannerPortada`][i].enlace} /></span>
                                                }
                                            </div>
                                        </div>
                                    )}
